# Goldbach Conjecture — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/goldbach-conjecture-canonical-lane-mathlib.git
cd goldbach-conjecture-canonical-lane-mathlib
lake exe
lake build
```
