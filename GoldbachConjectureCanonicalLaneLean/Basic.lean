/-!
# goldbach-conjecture-canonical-lane Lean migration boundary
...
`GoldbachConjectureCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "goldbach-conjecture-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/goldbach-conjecture-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for the Goldbach Conjecture: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["goldbach-conjecture", "mathematical-proof", "number-theory", "reproducibility", "additive-number-theory", "circle-method", "prime-sums", "canonical-lane", "local-to-global", "manifold-constrained"]
